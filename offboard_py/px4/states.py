...
class State:
    ...
    def set_attitude(self, attitude):
        # wxyz -> xyzw
        self.attitude[0] = attitude[1]
        self.attitude[1] = attitude[2]
        self.attitude[2] = attitude[3]
        self.attitude[3] = attitude[0]

    def get_attitude(self):
        # xyzw -> wxyz
        attitude = np.zeros(4)
        attitude[0] = self.attitude[3]
        attitude[1] = self.attitude[0]
        attitude[2] = self.attitude[1]
        attitude[3] = self.attitude[2]
        return attitude
    ...
    def get_position_ned_euler(self):
        position = np.zeros(3)
        position[0] = self.position[1]
        position[1] = self.position[0]
    ...
    def get_linear_velocity_ned_euler(self):
        velocity = np.zeros(3)
        velocity[0] = self.linear_velocity[1]
        velocity[1] = self.linear_velocity[0]
        velocity[2] = -self.linear_velocity[2]
        return velocity
    ...
    def get_linear_acceleration_ned_euler(self):
        acceleration = np.zeros(3)
        acceleration[0] = self.linear_acceleration[1]
        acceleration[1] = self.linear_acceleration[0]
        acceleration[2] = -self.linear_acceleration[2]
        return acceleration